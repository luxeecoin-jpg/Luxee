            ...
            <div className="flex items-baseline gap-3">
              ...
              {(product.oldPrice ?? 0) > product.price && (
                <>
                  ...
                  <span className="text-sm font-bold text-green-600 bg-green-50 px-2 py-0.5 rounded">Save ₹{(product.oldPrice ?? 0) - product.price}</span>
                </>
              )}
            </div>
